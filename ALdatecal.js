...
async function startcounting() {
  ...
  document.getElementById("start_date").innerHTML = date1.getDate() + "-" + (date1.getMonth()+1) + "-" + date1.getFullYear()
...
async function endcounting() {
  ...
  document.getElementById("end_date").innerHTML = date1.getDate() + "-" + (date1.getMonth()+1) + "-" + date1.getFullYear()
  const date2 = new Date();
  const diffTime = Math.abs(date2 - date1);
